  ...
  <div class="start-process-model">
      ...
      <div class="clearfix list">
        ...
        <div class="cont">
          <x-select
            ...
            <x-input slot="trigger" slot-scope="{ selectedModel }" readonly
              ...
              <em slot="suffix" class="ans-icon-fail-solid" style="font-size: 15px;cursor: pointer;"
                  v-show="warningGroupId"></em>
          ...
          <div class="list-model">
            <div class="table-box">
              <table class="fixed">
                ...
                <tr v-for="(item, $index) in instanceParameters"
                    :key="$index">
                  <td>
                    <span>{{$index+1}}</span>
                  </td>
    ...
    <div class="bottom">
      <div class="submit">
        ...
        <x-button type="primary" shape="circle" :loading="spinnerLoading" @click="ok()">
...
export default {
  ...
  methods: {
    ...
    _start() {
      console.log("start")
      console.log(this.instanceParameters)
      ...
      let param = {
        ...
        instanceParameters: JSON.stringify(this.instanceParameters)
      }
    ...
    _getGlobalParams() {
      this.store.dispatch('dag/getGlobalParams', {processDefinitionId: this.item.id}).then(res => {
        this.instanceParameters = res
      })
    },
    ok() {
      this._start()
